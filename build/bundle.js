...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoItems = __webpack_require__(157);
	...
	var Todo = React.createClass({
		...
		getInitialState: function getInitialState() {
			return {
				"todoItems": [{ "item": "Test Item 1", "completed": false, "isEditMode": false }, { "item": "Test Item 2", "completed": false, "isEditMode": false }, { "item": "Test Item 3", "completed": false, "isEditMode": false }, { "item": "Test Item 4", "completed": true, "isEditMode": false }]
			};
		},
		...
		handleCompletion: function handleCompletion(e) {
			var items = this.state.todoItems;
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'div',
						{ className: 'col-md-5 col-md-push-4' },
						React.createElement(
							'form',
							...
							React.createElement(
								...
								React.createElement('input', { ref: 'todoitem', type: 'text', className: 'form-control', id: 'todoitem', placeholder: 'Todo Item' })
							)
						)
					)
				),
	...
	var TodoItems = React.createClass({
		...
		editMode: function editMode(item) {
			return React.createElement(
				...
				React.createElement("input", { className: "input", value: this.state.item, onChange: this.handleChange })
			);
		},
		...
		render: function render() {
			return React.createElement(
				...
				this.props.todoItems.map(function (item, i) {
					...
					return React.createElement(
						"li",
						{ key: i, className: defaultClass + ' list-group-item', onDoubleClick: this.props.handleEdit.bind(null, i) },
						...
						React.createElement(
							...
							React.createElement(
								"button",
								{ onClick: this.props.handleCompletion.bind(null, i), className: "btn btn-success btn-xs" },
								React.createElement("i", { className: "fa fa-check" })
							),
							React.createElement(
								"button",
								{ onClick: this.props.handleDelete.bind(null, i), className: "btn btn-danger btn-xs" },
